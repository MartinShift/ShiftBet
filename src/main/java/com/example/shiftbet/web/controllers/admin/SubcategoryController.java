...
public class SubcategoryController {
    ...
    @GetMapping("/admin/subcategory/add")
    ...
    @GetMapping("/admin/subcategory/view")
    ...
    public String add(Subcategory  subcategory, MultipartHttpServletRequest request) throws IOException {
       subcategory.setImageUrl(imageFileService.saveImage(request.getFile("image")));
        ...
        return "redirect:/admin/subcategory/view";
    }

    @GetMapping("/admin/subcategory/edit/{id}")
    ...
    @PostMapping("/admin/subcategory/edit")
